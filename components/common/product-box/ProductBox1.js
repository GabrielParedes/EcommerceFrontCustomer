    ...
    <div className="product-box product-wrap">
      <div className="img-wrapper">
        <div className="lable-block">
          ...
          {product.sale === true ? <span className="lable4">En oferta</span> : ""}
        </div>
        ...
        <div className={cartClass}>
          ...
          {/* <a href={null} title="Agregar a la wishlist" onClick={addWishlist}>
            <i className="fa fa-heart" aria-hidden="true"></i>
          </a> */}
          <a href={null} title="Vista rápida" onClick={toggle}>
            ...
            <Col lg="6" className="rtl-text">
              <div className="product-right">
                ...
                <div className="border-product">
                  <h6 className="product-title">Detalle del producto</h6>
